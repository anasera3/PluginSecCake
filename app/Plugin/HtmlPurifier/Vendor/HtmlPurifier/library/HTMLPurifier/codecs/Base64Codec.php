 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_Base64Codec extends Codec
{
    /**
     * Public Constructor
     */
    ...
    {
        $logger = HTMLPurifier_ESAPI::getAuditor("Base64");
    }
    ...
    public function afficber(){
        
        
        echo' hi i am the coddec ' ;
    }
     ...
     */
    public function encodeCharacter($immune=array(""),$input)
    {
