...
abstract class Codec
{
    ...
    {
        // debug
        HTMLpurifier_CodecDebug::getInstance()->addUnencodedString(
        ...
        // debug
        HTMLPurifier_CodecDebug::getInstance()->output($encodedString);
    ...
    function decode($input)
    {
        ...
        // debug
        HTMLPurifier_CodecDebug::getInstance()->addEncodedString($_4ByteString);
        ...
        // debug
        HTMLPurifier_CodecDebug::getInstance()->output($decodedString);
