 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_DefaultEncoder implements Encoder
{
    ...
    {
        $this->logger = HTMLPurifier_ESAPI::getAuditor("Encoder");

        // initialise codecs
        $this->_base64Codec     = new HTMLPurifier_Base64Codec();
        $this->_cssCodec        = new HTMLPurifier_CSSCodec();
        $this->_htmlCodec       = new HTMLPurifier_HTMLEntityCodec();
        $this->_javascriptCodec = new JavaScriptCodec();
        $this->_percentCodec    = new HTMLPurifier_PercentCodec();
        $this->_vbscriptCodec   = new HTMLPurifier_VBScriptCodec();
        $this->_xmlCodec        = new HTMLPurifier_XMLEntityCodec();
    ...
    function encodeForOS($codec, $input)
    {
        ...
        if ($codec instanceof Codec == false) {
            HTMLPurifier_ESAPI::getLogger('Encoder')->error(
