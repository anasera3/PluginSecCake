 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_DefaultValidator implements HTMLPurifier_Validator
{
    ...
    {
        global $ESAPI;
        $this->_auditor = HTMLPurifier_ESAPI::getAuditor('DefaultValidator');
        $this->_encoder = HTMLPurifier_ESAPI::getEncoder();
    }
    ...
    public function afficher(){
        ...
        echo 'test de cette default validator';
