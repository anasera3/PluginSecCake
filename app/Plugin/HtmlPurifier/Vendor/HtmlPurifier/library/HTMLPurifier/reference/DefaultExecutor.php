 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_DefaultExecutor implements Executor
{
    ...
    {
        $this->_auditor = HTMLPurifier_ESAPI::getAuditor('HTMLPurifier_Executor');
        $this->_config = HTMLPurifier_ESAPI::getSecurityConfiguration();
    }
