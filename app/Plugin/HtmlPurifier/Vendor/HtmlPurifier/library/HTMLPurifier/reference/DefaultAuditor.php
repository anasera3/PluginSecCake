...
/**
 *C:\xampp\htdocs\mssipfe\app\Plugin\HtmlPurifier\Vendor\HtmlPurifier\library\HTMLPurifier\lib\apache-log4php\trunk\src\main\php
 * C:\xampp\htdocs\mssipfe\app\Plugin\HtmlPurifier\Vendor\HtmlPurifier\library\HTMLPurifier\lib\apache-log4php\trunk\src
 * C:\xampp\htdocs\mssipfe\app\Plugin\HtmlPurifier\Vendor\HtmlPurifier\library\HTMLPurifier\reference\lib\apache-log4php\trunk\src\main\php\Logger.php
 * 
 */
require_once dirname(__FILE__) .'\..\lib\apache-log4php\trunk\src\main\php\Logger.php';
 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_DefaultAuditor implements Auditor
{
    ...
    function __construct($name)
    {
        ...
        $sc = HTMLPurifier_ESAPI::getSecurityConfiguration();
    ...
    private function _log($level, $type, $success, $message, $throwable)
    {
        ...
        $encoder   = HTMLPurifier_ESAPI::getEncoder();
        $secConfig = HTMLPurifier_ESAPI::getSecurityConfiguration();
        ...
        $request = HTMLPurifier_ESAPI::getHttpUtilities()->getCurrentRequest();
        if ($request === null) {
            $request = new HTMLPurifier_SafeRequest;
            HTMLPurifier_ESAPI::getHttpUtilities()->setCurrentHTTP($request);
        }
