 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_DefaultSanitizer implements Sanitizer
{
    ...
    {
        global $ESAPI;
        $this->encoder = HTMLPurifier_ESAPI::getEncoder();
    }
    ...
    {
        $hvr = new HTMLPurifier_HTMLValidationRule('HTML_Validator', $this->encoder);
