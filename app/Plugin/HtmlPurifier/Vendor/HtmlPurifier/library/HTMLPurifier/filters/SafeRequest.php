 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_SafeRequest
{
    /*
    ...
    {
        $codecs = array(
            new HTMLPurifier_HTMLEntityCodec,
            new HTMLPurifier_PercentCodec
        );
        $this->_encoder    = new HTMLPurifier_DefaultEncoder($codecs);
        $this->_auditor    = HTMLPurifier_ESAPI::getAuditor('SafeRequest');
        $this->_validator  = HTMLPurifier_ESAPI::getValidator();
