 ...
 *
 * This file is part of the Open Web AEnterpriseSecuritypplication Security Project (OWASP)
...
public function test(){
    ...
    public static function getAccessController() 
    {
        if ( is_null(self::$_accessController) ) {
            ...
            self::$_accessController = new HTMLPurifier_FileBasedAccessController();
        }
    ...
    public static function getEncoder() 
    {
        if ( is_null(self::$_encoder) ) {
            ...
            self::$_encoder = new HTMLPurifier_DefaultEncoder();
        }
    ...
    {
       throw new HTMLPurifier_EnterpriseSecurityException(
            'Method Not implemented',
            'Encryptor not implemented'
        );
    }
    ...
    public static function getExecutor() 
    {
        if ( is_null(self::$_executor) ) {
            ...
            self::$_executor = new HTMLPurifier_DefaultExecutor();
        }
    ...
    public static function getHttpUtilities() 
    {
        if ( is_null(self::$_httpUtilities) ) {
            ...
            self::$_httpUtilities = new HTMLPurifier_DefaultHTTPUtilities();
        }
    ...
    public static function getIntrusionDetector() 
    {
        if ( is_null(self::$_intrusionDetector) ) {
            ...
            self::$_intrusionDetector = new HTMLPurifier_DefaultIntrusionDetector();
        }
    ...
    public static function getAuditor($logger) 
    {
        if (self::$_auditorFactory == null) {
            ...
            self::setAuditorFactory(new HTMLPurifier_DefaultAuditorFactory());
        }
    ...
    public static function getRandomizer() 
    {
        if ( is_null(self::$_randomizer) ) {
            ...
            self::$_randomizer = new HTMLPurifier_DefaultRandomizer();
        }
    ...
    public static function getSecurityConfiguration($path = '') 
    {
        if ( is_null(self::$_securityConfiguration) ) {
            ...
            self::$_securityConfiguration = new HTMLPurifier_DefaultSecurityConfiguration($path);
        }
    ...
    public static function getValidator() 
    {
        if ( is_null(self::$_validator) ) {
            ...
            self::$_validator = new HTMLPurifier_DefaultValidator();
        }
    ...
    public static function getSanitizer() 
    {
        if ( is_null(self::$_sanitizer) ) {
            ...
            self::$_sanitizer = new HTMLPurifier_DefaultSanitizer();
        }
