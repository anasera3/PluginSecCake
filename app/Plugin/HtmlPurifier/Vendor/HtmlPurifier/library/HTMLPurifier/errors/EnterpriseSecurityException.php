 ...
 * @link      http://www.owasp.org/index.php/ESAPI
 */
class HTMLPurifier_EnterpriseSecurityException extends HTMLPurifier_Exception
{
    /** The logger. */
    protected $logger;
    ...
    public function __construct($userMessage = '', $logMessage = '')
    {
        ...
        $this->logger = HTMLPurifier_ESAPI::getAuditor("EnterpriseSecurityException");
        if (! HTMLPurifier_ESAPI::getSecurityConfiguration()->getDisableIntrusionDetection()) {
            HTMLPurifier_ESAPI::getIntrusionDetector()->addException($this);
        }
    }
